...
template<class T>
void free2dvector(vector<T> vec)
{
...
//	double b1 , b2, g1, g2 , r1, r2;
	...
	for(int i = 0, k = 0; i < __nPixels; i++, k+=3)
	{
		...
		Y1 = Y1>0 ? Y1:0;
		Y1 = Y1<image->height ? Y1:(image->height-1);
		X = X>0 ? X:0;
		X = X<image->width ? X:(image->width-1);
		X1 = X1>0 ? X1:0;
		X1 = X1<image->width ? X1:(image->width-1);
...
*/
		/*cout<<"******************************************************************\n";
		cout<<"ixB1 = "<<ixB1<<" ixB2 = "<<ixB2<<endl;
		cout<<"ixG1 = "<<ixG1<<" ixG2 = "<<ixG2<<endl;
		cout<<"ixR1 = "<<ixR1<<" ixR2 = "<<ixR2<<endl; 
		cout<<"i = "<<i<<" k = "<<k<<endl;
		cout<<"image.width = "<<image->width<<" image.height = "<<image->height<<" image.step = "<<image->widthStep<<endl;*/
