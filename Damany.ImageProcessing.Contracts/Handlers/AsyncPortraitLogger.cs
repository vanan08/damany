...
namespace Damany.Imaging.Handlers
{
    public class AsyncPortraitLogger : PortraitsLogger
    {
        ...
        public override void HandlePortraits(IList<Damany.Imaging.Common.Frame> motionFrames,
        ...
        private Queue<IList<Damany.Imaging.Common.Portrait>> portraitQueue
            = new Queue<IList<Damany.Imaging.Common.Portrait>>();
